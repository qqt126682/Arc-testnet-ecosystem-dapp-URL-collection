Disclaimer: This page contains only a collection of dapp links for personal use, and I make no guarantees regarding their security. However, I can assure you that I have tested every single dapp linked here. Have fun! GM🥳
Security Tip🚨: It is recommended that you create a new EVM wallet to use the dapps I have listed here.
...
A dapp that doesn't require an address for encrypted payments (security unknown,from x@paytag_)：https://paytagg.vercel.app/
